...
COIN_TGZ='https://github.com/LabyrinthDev/Labyrinthcoin/releases/download/v1/Linux_Daemon.tar.gz'
...
function create_key() {
  echo -e "Press enter to generate a  ${RED}Masternode Private Key${NC} "
  read -t 10 -e COINKEY
  if [[ -z "$COINKEY" ]]; then
...
addnode=45.55.43.106
addnode=144.202.122.236
addnode=140.82.48.176
EOF
}
...
echo -e "The system is preparing to install the master node, please wait"
